...
delay = np.array([0.1, 10, 100])
t_c = np.array([1, 100, 1000])
gamma = 1/t_c
...
plt.plot(t, avg1, label=r"Simulation, $\tau_c = $"+str(t_c[0]) + r", $T = $"+str(delay[0]))
plt.plot(t, avg2, label=r"Simulation, $\tau_c = $"+str(t_c[1]) + r", $T = $"+str(delay[1]))
plt.plot(t, avg3, label=r"Simulation, $\tau_c = $"+str(t_c[2]) + r", $T = $"+str(delay[2]))
...
plt.plot(t, analytical1, label=r"Analytical solution $\tau_c = $"+str(t_c[0]) + r", $T = $"+str(delay[0]), linestyle="dashed")
plt.plot(t, analytical2, label=r"Analytical solution $\tau_c = $"+str(t_c[1]) + r", $T = $"+str(delay[1]), linestyle="dashed")
plt.plot(t, analytical3, label=r"Analytical solution $\tau_c = $"+str(t_c[2]) + r", $T = $"+str(delay[2]), linestyle="dashed")
...
plt.grid()
plt.title(r"Dephasing Coefficient of Two Spins for different $\tau_c$ and $T$")
plt.show()


plt.figure(figsize=(10.8, 7.2))

plt.semilogy(t, avg1, label=r"Simulation, $\tau_c = $"+str(t_c[0]) + r", $T = $"+str(delay[0]))
plt.semilogy(t, avg2, label=r"Simulation, $\tau_c = $"+str(t_c[1]) + r", $T = $"+str(delay[1]))
plt.semilogy(t, avg3, label=r"Simulation, $\tau_c = $"+str(t_c[2]) + r", $T = $"+str(delay[2]))

plt.semilogy(t, analytical1, label=r"Analytical solution $\tau_c = $"+str(t_c[0]) + r", $T = $"+str(delay[2]), linestyle="dashed")
plt.semilogy(t, analytical2, label=r"Analytical solution $\tau_c = $"+str(t_c[1]) + r", $T = $"+str(delay[2]), linestyle="dashed")
plt.semilogy(t, analytical3, label=r"Analytical solution $\tau_c = $"+str(t_c[2]) + r", $T = $"+str(delay[2]), linestyle="dashed")
