...
delay = np.array([10, 10, 10])
t_c = np.array([1, 10, 100])
gamma = 1/t_c
...
plt.plot(t, avg1, label=r"Simulation, $\tau_c = $"+str(t_c[0]))
plt.plot(t, avg2, label=r"Simulation, $\tau_c = $"+str(t_c[1]))
plt.plot(t, avg3, label=r"Simulation, $\tau_c = $"+str(t_c[2]))
...
plt.plot(t, analytical1, label=r"Analytical solution $\tau_c = $"+str(t_c[0]), linestyle="dashed")
plt.plot(t, analytical2, label=r"Analytical solution $\tau_c = $"+str(t_c[1]), linestyle="dashed")
plt.plot(t, analytical3, label=r"Analytical solution $\tau_c = $"+str(t_c[2]), linestyle="dashed")
...
plt.legend()
plt.grid()
plt.title(r"Dephasing Coefficient of Two Spins with $T = $" + str(delay[0]))
plt.show()


plt.semilogy(t, avg1, label=r"Simulation, $\tau_c = $"+str(t_c[0]))
plt.semilogy(t, avg2, label=r"Simulation, $\tau_c = $"+str(t_c[1]))
plt.semilogy(t, avg3, label=r"Simulation, $\tau_c = $"+str(t_c[2]))

plt.semilogy(t, analytical1, label=r"Analytical solution $\tau_c = $"+str(t_c[0]), linestyle="dashed")
plt.semilogy(t, analytical2, label=r"Analytical solution $\tau_c = $"+str(t_c[1]), linestyle="dashed")
plt.semilogy(t, analytical3, label=r"Analytical solution $\tau_c = $"+str(t_c[2]), linestyle="dashed")
