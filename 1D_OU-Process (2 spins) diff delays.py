...
plt.plot(t, avg1, label=r"Simulation, $T = $"+str(delay[0]))
plt.plot(t, avg2, label=r"$Simulation, $T = $"+str(delay[1]))
plt.plot(t, avg3, label=r"$Simulation, T = $"+str(delay[2]))
...
plt.semilogy(t, avg1, label=r"Simulation, $T = $"+str(delay[0]))
plt.semilogy(t, avg2, label=r"Simulation, $T = $"+str(delay[1]))
plt.semilogy(t, avg3, label=r"Simulation, $T = $"+str(delay[2]))

plt.semilogy(t, analytical1, label=r"Analytical solution $T = $"+str(delay[0]), linestyle="dashed")
plt.semilogy(t, analytical2, label=r"Analytical solution $T = $"+str(delay[1]), linestyle="dashed")
plt.semilogy(t, analytical3, label=r"Analytical solution $T = $"+str(delay[2]), linestyle="dashed")
