...
delay = np.array([1, 10, 100])
t_c = np.array([10, 10, 10])
gamma = 1/t_c
...
plt.semilogy(t, avg1, label=r"$T = $"+str(delay[0]))
plt.semilogy(t, avg2, label=r"$T = $"+str(delay[1]))
plt.semilogy(t, avg3, label=r"$T = $"+str(delay[2]))
