...
avg1, var1 = average_dephasing(totalTime, timeStep, totalLength, xStep, tgamma1, xgamma1, v1, T1, N)
avg2, var2 = average_dephasing(totalTime, timeStep, totalLength, xStep, tgamma2, xgamma2, v1, T1, N)
avg3, var3 = average_dephasing(totalTime, timeStep, totalLength, xStep, tgamma3, xgamma3, v1, T1, N)
